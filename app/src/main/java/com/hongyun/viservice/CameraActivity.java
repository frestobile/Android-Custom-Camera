...
//    private static final long MAX_VIDEO_LENGTH = 420 * 1000;
//
...
//        Log.e("preview height",""+mPreviewWidth+"   "+mPreviewHeight);
////        int height = displaymetrics.heightPixels;
////        int width = displaymetrics.widthPixels;
////        setPreviewSize(width, height);
////        mPreview.setCroppedSizeWeight(height, width);
...
//                    @Override
//                    public void run() {
//                        Toast.makeText(CameraActivity.this,"Permission Denied. Exit.", Toast.LENGTH_SHORT).show();
//                        finish();
//                    }
//                };
//            }
...
//                mIntent.putExtra("PATH", mVideo.getPath());
...
//
//        }
//        if (i == R.id.imgCapture) {
//            if (mRecording) {
//                pauseRecording();
//                // check video length
//                if (calculateTotalRecordedTime(mRecordFragments) < MIN_VIDEO_LENGTH) {
//                    Toast.makeText(this,"Video Too Short", Toast.LENGTH_SHORT).show();
//                    return;
//                }
...
//       final Camera.Size optimalSize = getOptimalPreviewSize(previewSizes, getResources().getDisplayMetrics().widthPixels, getResources().getDisplayMetrics().heightPixels);
//
...
//        }
//        Log.e("result...",""+optimalSize.width+"  "+optimalSize.height);
...
//        byte[] bufferByte = new byte[optimalSize.width * optimalSize.height * 3 / 2];
...
//                        } else {
//                            frame = new Frame(optimalSize.width, optimalSize.height, frameDepth, frameChannels);
...
//
//        mFrameRecorder = new FFmpegFrameRecorder(mVideo, mPreviewWidth, mPreviewHeight, 1);
...
//                    // swap width and height
//                    scale = String.format("scale=%d:%d", mPreviewWidth, mPreviewHeight);
//                    break;
...
//
//            Intent intent = new Intent(CameraActivity.this, PhotoVideoRedirectActivity.class);
