...
public class CameraView extends RelativeLayout {
    ...
    public CameraView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutParams textureViewParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        ...
        flash = typedArray.getInt(R.styleable.CameraView_flash, Values.FLASH_ON);
    ...
    private void addOverlay() {
        ...
        LayoutParams overlayParams = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
